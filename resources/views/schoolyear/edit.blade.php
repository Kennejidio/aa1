    ...
    <section class="d-flex justify-content-center my-5">
        ...
        mb-5">
            ...
            <div class="text-center">
                <h2 class="text-darkpink">EDIT SCHOOL YEAR</h2>
            </div>
            @if ($errors->any())
            ...
            <div class="row mt-4">
                <div class="col-md input-group mt-1">
                    ...
                    <input class="form-control" value="{{ $schoolyear->start_date }}" type="text" name="start_date">
                </div>
                <div class="col-md input-group mt-1">
                    <span class="input-group-text">END DATE</span>
                    <input class="form-control" value="{{ $schoolyear->end_date }}" type="text" name="end_date">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md input-group mt-1">
                    <textarea class="form-control" cols="30" rows="2" name="description">{{ $schoolyear->description }}</textarea>
                </div>
            </div>
