        ...
        <div class="row bg-gray-200 shadow my-4">
            <div class="col-lg-6">
                @can('schoolyear-create')
                    <a href="{{ route('schoolyear.create') }}" class="btn mt-2">
                        <div>
                            ...
                            <td class="text-center">
                                <form action="{{ route('schoolyear.destroy', $schoolyear->id) }}" method="POST">
                                    <a class="btn btn-blue m-1"
                                        href="{{ route('schoolyear.show', $schoolyear->id) }}">Show</a>
                                    @can('schoolyear-edit')
                                        <a class="btn btn-green m-1"
                                            href="{{ route('schoolyear.edit', $schoolyear->id) }}">Edit</a>
                                    @endcan
                                    @csrf
                                    @method('DELETE')
                                    @can('schoolyear-delete')
