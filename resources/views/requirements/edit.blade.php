    ...
    <section class="d-flex justify-content-center my-5">
        ...
        mb-5">
            ...
            <div class="text-center">
                <h2 class="text-darkpink">EDIT REQUIREMENTS</h2>
            </div>
            @if ($errors->any())
            ...
            <div class="row mt-4">
                <div class="col-md input-group mt-1">
                    ...
                    <input class="form-control" value="{{ $requirement->requirement }}" type="text" name="requirement">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md input-group mt-1">
                    <textarea class="form-control" cols="30" rows="2" name="description">{{ $requirement->description }}</textarea>
                </div>
            </div>
