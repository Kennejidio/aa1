        ...
        <div class="bg-white rounded-1 shadow p-3 mb-5">
            ...
            <div class="row">
                <div class="col-md mt-1">
                    ...
                    <input class="form-control " disabled
                        value="{{ $enrollment->student->firstname }} {{ $enrollment->student->middlename }}
                    {{ $enrollment->student->lastname }} {{ $enrollment->student->extname }}">
                </div>
                <div class="col-md mt-1">
                    <span class="fw-bolder">Grade Level</span>
                    <input class="form-control " disabled value="{{ $enrollment->section->grade_level->code }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md mt-1">
                    <span class="fw-bolder">Section</span>
                    <input class="form-control " disabled value="{{ $enrollment->section->code }}">
                </div>
                <div class="col-md mt-1">
            ...
            <div class="row">
                <div class="col-md mt-1">
                    ...
                    <input class="form-control " disabled
                        value="{{ $enrollment->school_year->start_date }} - {{ $enrollment->school_year->end_date }}">
                </div>
                <div class="col-md mt-1">
