    ...
    <section class="d-flex justify-content-center my-5">
        ...
        <div class="bg-white rounded-1 shadow p-3 pb-5">
            <div class="text-center">
                <h2 class="text-darkpink">SHOW SECTION</h2>
            </div>

            <div class="text-center mt-4">
                <h6 class="h6">SECTION</h6>
            </div>
            <div class="row text-center">
                <div class="col">
                    <p class="fst-normal">{{ $section->code }}</p>
                </div>
            </div>

            <div class="text-center mt-4">
                <h6 class="h6">GRADE LEVEL</h6>
            </div>
            <div class="row text-center">
                <div class="col">
                    <p class="fst-normal">{{ $section->grade_level->code }}</p>
                </div>
            </div>
